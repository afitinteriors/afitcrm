...
// Mobile counterpart to DealRow -- same card shape as LeadCard/
// SiteVisitCard/QuotationCard, showing quotation_amount and job_value as
// two explicit lines rather than one merged value (see DealRow.tsx).
export function DealCard({ lead }: { lead: LeadListRow }) {
  return (
    <li>
      <Link
        href={`/leads/${lead.id}`}
