    ...
    <div className="space-y-4 p-4">
      ...
      <div className="grid grid-cols-2 gap-2 pt-1">
        <a
          ...
          title="Call"
          className="flex h-11 items-center justify-center rounded-lg border border-slate-300 text-slate-700 active:bg-slate-100"
        >
        ...
        <a
          ...
          className="flex h-11 items-center justify-center rounded-lg border border-slate-300 text-[#25D366] active:bg-slate-100"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
